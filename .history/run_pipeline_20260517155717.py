...
def run_script(step_name: str, script_name: str, args: list = None): # type: ignore
    ...
    try:
        ...
        print(f"\n❌ FAILED: Could not find script '{script_name}'.")
        raise Exception(f"Pipeline halted: File not found ({script_name}). Check your directory.") from e
...
def execute_pipeline(tournament_url: str):
    ...
    # Steps 2-7: The state-driven cleanup crew
    STATE_DRIVEN_STEPS = [
