...
def scrape_match_draft(game_url, conn):
    ...
    # NEW LOGIC: Fetch blue and red team IDs from the matches table
    ...
    for idx, template in enumerate(draft_sequence, start=1):
        ...
        # Dynamically assign the correct team_id based on the side
        ...
        if current_pointer < len(champion_list):
            ...
            # Updated INSERT logic to handle the team_id
            sql = """
